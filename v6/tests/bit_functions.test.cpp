...
void bit_clear_test()
{
  ...
  "hal::bit clear() increment (0)"_test = []() {
    ...
    expect(that % 0x0000'0000 ==
           control_register.clear<hal::bit_mask::from(0)>().to<std::uint32_t>());
    expect(that % 0x0000'0000 ==
           control_register.clear<hal::bit_mask::from(1)>().to<std::uint32_t>());
    expect(that % 0x0000'0000 ==
           control_register.clear<hal::bit_mask::from(2)>().to<std::uint32_t>());
  };
  ...
  "hal::bit clear() increment upper half (0x1'FFFF)"_test = []() {
    ...
    expect(that % 0x0000'FFFF ==
           control_register.clear<hal::bit_mask::from(16)>().to<std::uint32_t>());
    expect(that % 0x0000'FFFF ==
           control_register.clear<hal::bit_mask::from(17)>().to<std::uint32_t>());
    expect(that % 0x0000'FFFF ==
           control_register.clear<hal::bit_mask::from(18)>().to<std::uint32_t>());
  };
  ...
  "hal::bit clear() multiple bits (0xFFFF'FFFF)"_test = []() {
    ...
    expect(that % 0xFFFF'FF00 ==
           control_register.clear<hal::bit_mask::from(0, 7)>()
             .to<std::uint32_t>());
    expect(that % 0xFFE1'FF00 ==
           control_register.clear<hal::bit_mask::from(17, 20)>()
             .to<std::uint32_t>());
    expect(that % 0xE001'FF00 ==
           control_register.clear<hal::bit_mask::from(21, 28)>()
             .to<std::uint32_t>());
  };
}
...
void bit_extract_test()
{
  ...
  "hal::bit extract() single input increment(0)"_test = []() {
    ...
    constexpr auto extract_mask = hal::bit_mask::from(0);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
    expect(that % 0x1 == extracted);
  };

  "hal::bit extract() single input increment(4)"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(4);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
  ...
  "hal::bit extract() single input increment(8)"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(8);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
    expect(that % 0x1 == extracted);
  };
  ...
  "hal::bit extract() double input increment(0)"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(0, 1);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
    expect(that % 0x1 == extracted);
  };
  ...
  "hal::bit extract() double input increment(4)"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(0, 3);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
  ...
  "hal::bit extract() double input increment(8)"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(0, 7);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
  ...
  "hal::bit extract() double input increment(4,7)"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(4, 7);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
  ...
  "hal::bit extract() double input increment(8,15)"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(8, 15);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
  ...
  "hal::bit extract() double input upper half"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(16, 23);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
  ...
  "hal::bit extract() double input out of range"_test = []() {
    std::uint32_t control_register = 0x0123'ABCD;
    constexpr auto extract_mask = hal::bit_mask::from(24, 39);
    auto const extracted = hal::bit_extract<extract_mask>(control_register);
...
void bit_insert_test()
{
  ...
  "hal::bit insert single input increment (0)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0x0;
    static constexpr auto insert_mask = hal::bit_mask::from(0);
  ...
  "hal::bit insert single input increment (1)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0x0;
    static constexpr auto insert_mask = hal::bit_mask::from(1);
    expect(that % 0x0000'0002 ==
           control_register.insert<insert_mask>(0xFFFFUL).to<std::uint32_t>());
  };
  ...
  "hal::bit insert single input increment (16)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0x0;
    static constexpr auto insert_mask = hal::bit_mask::from(16);
  ...
  "hal::bit insert double input increment (0)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0xFFFF'FFFF;
    static constexpr auto insert_mask = hal::bit_mask::from(0, 15);
  ...
  "hal::bit insert double input increment (1)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0xFFFF'FFFF;
    static constexpr auto insert_mask = hal::bit_mask::from(1, 15);
  ...
  "hal::bit insert double input increment (16)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0xFFFF'FFFF;
    static constexpr auto insert_mask = hal::bit_mask::from(16, 31);
  ...
  "hal::bit insert double input increment out of range"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0xFFFF'FFFF;
    static constexpr auto insert_mask = hal::bit_mask::from(27, 42);
...
void bit_set_test()
{
  ...
  "hal::bit set() increment (0)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0x0;
    expect(that % 0x0000'0001 ==
           control_register.set<hal::bit_mask::from(0)>().to<std::uint32_t>());
    expect(that % 0x0000'0003 ==
           control_register.set<hal::bit_mask::from(1)>().to<std::uint32_t>());
    expect(that % 0x0000'0007 ==
           control_register.set<hal::bit_mask::from(2)>().to<std::uint32_t>());
  };
  ...
  "hal::bit set() increment upper half (0x1'FFFF)"_test = []() {
    ...
    expect(that % 0x0001'FFFF ==
           control_register.set<hal::bit_mask::from(16)>().to<std::uint32_t>());
    expect(that % 0x0003'FFFF ==
           control_register.set<hal::bit_mask::from(17)>().to<std::uint32_t>());
    expect(that % 0x0007'FFFF ==
           control_register.set<hal::bit_mask::from(18)>().to<std::uint32_t>());
  };
}
...
void bit_toggle_test()
{
  ...
  "hal::bit toggle() increment (0)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0x0;
    expect(that % 0x0000'0001 ==
           control_register.toggle<hal::bit_mask::from(0)>()
             .to<std::uint32_t>());
    expect(that % 0x0000'0003 ==
           control_register.toggle<hal::bit_mask::from(1)>()
             .to<std::uint32_t>());
    expect(that % 0x0000'0007 ==
           control_register.toggle<hal::bit_mask::from(2)>()
             .to<std::uint32_t>());
  };
  ...
  "hal::bit toggle() increment upper half (0x1'FFFF)"_test = []() {
    hal::bit_value<std::uint32_t> control_register = 0x1'FFFF;
    expect(that % 0x0000'FFFF ==
           control_register.toggle<hal::bit_mask::from(16)>()
             .to<std::uint32_t>());
    expect(that % 0x0002'FFFF ==
           control_register.toggle<hal::bit_mask::from(17)>()
             .to<std::uint32_t>());
    expect(that % 0x0006'FFFF ==
           control_register.toggle<hal::bit_mask::from(18)>()
             .to<std::uint32_t>());
  };
